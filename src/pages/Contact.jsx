        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4 pt-3 border-t border-brand-border/60">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm font-extrabold text-brand-secondary hover:underline"
                    >
                      {phone}
                    </a>
                  </div>
          ...
          <div className="mt-16 pt-12 border-t border-brand-border">
            <div className="flex items-center justify-between mb-6">
              ...
              <a
                href="https://maps.google.com/?q=Azhagiyamandapam+Tamil+Nadu"
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs sm:text-sm font-bold text-brand-secondary hover:underline"
              >
                Open in Google Maps →
              </a>
            </div>
            
            <div className="rounded-3xl overflow-hidden border border-brand-border shadow-soft h-80 sm:h-96 w-full bg-gray-100">
              <iframe
                src={mapEmbedUrl}
                width="100%"
                height="100%"
